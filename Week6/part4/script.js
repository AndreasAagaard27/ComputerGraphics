...
window.onload = async function init() {
    ...
    document.getElementById("ksSlider").addEventListener("input", (event) => {
        ks = parseFloat(event.target.value);
    });

    document.getElementById("shininessSlider").addEventListener("input", (event) => {
        shininess = parseFloat(event.target.value);
    });

    document.getElementById("leSlider").addEventListener("input", (event) => {
        le = parseFloat(event.target.value);
    });

    document.getElementById("laSlider").addEventListener("input", (event) => {
